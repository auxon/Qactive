...
namespace Qactive
{
  ...
  {
    private static readonly Type rxQuery = typeof(Qbservable).GetAssembly().GetType("System.Reactive.ObservableQuery`1", throwOnError: true).MakeGenericType(typeof(TSource));
