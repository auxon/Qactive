...
{
  [TestClass]
  public class WebSocketDuplexTests : TestBase
  {
    [TestMethod]
    ...
    {
      var service = WebSocketTestService.Create(WebSocketTestService.UnrestrictedOptions, new[] { typeof(NonSerializableObject) }, Observable.Return(new TestContext()));
