#define HAS_AWAIT
/* Retrieved from https://github.com/Reactive-Extensions/Rx.NET/ on June 19, 2016 by D.S.
 * 
 * Mods:
 * AsyncSubject renamed to AwaitableAsyncSubject, with the same impl as 2.2.5.
 * Replaced Strings_Linq.NO_ELEMENTS with a literal string error message.
 * 
 */
...
namespace System.Reactive.Subjects
{
  ...
  public sealed class AwaitableAsyncSubject<T> : SubjectBase<T>, IDisposable
#if HAS_AWAIT
        , INotifyCompletion
#endif
  {
...
#if HAS_AWAIT
    /// <summary>
    /// Gets an awaitable object for the current AwaitableAsyncSubject.
    /// </summary>
    ...
    public T GetResult()
    {
      ...
      if (!_hasValue)
        throw new InvalidOperationException("The AwaitableAsyncSubject completed without any values.");
